...
export const CURATED_NEXUS_MODELS = [
  { id: 'anthropic/claude-3.7-sonnet', name: 'Claude 3.7 Sonnet', tag: 'Top Frontier' },
  { id: 'openai/gpt-4o', name: 'GPT-4o', tag: 'Omni Frontier' },
  ...
  { id: 'mistralai/mistral-large-2411', name: 'Mistral Large', tag: 'Frontier EU' },
  { id: 'google/gemini-2.0-flash-exp:free', name: 'Gemini 2.0 Flash Exp (Free)', tag: 'Free Tier' },
      ...
      personas: [
        {
          ...
          systemPrompt:
            'You are Claude 3.7 Sonnet, Lead Architect in Nexus Lab. Provide profound structural insights, robust logic, and clear architectural trade-offs.',
          enabled: true,
        },
        {
          id: 'gpt4o_frontier',
    ...
    return {
      personas: [
        ...
        },
        {
          ...
          model: 'anthropic/claude-3.7-sonnet',
          systemPrompt:
            'You are Claude 3.7 Sonnet with extended thinking. Analyze core problem topology and build complete solution frameworks.',
          enabled: true,
        },
        {
      ...
      personas: [
        {
          ...
          systemPrompt: 'You are Gemini 2.0 Flash Exp. Provide rapid, concise, structured domain analysis.',
          enabled: true,
        },
        {
          id: 'llama_free',
          ...
          systemPrompt:
            'You are Llama 3.3 70B. Provide clear open-weights domain analysis and actionable recommendations.',
          enabled: true,
        },
      ],
      synthesizer: {
...
export const NexusLabView: React.FC<NexusLabViewProps> = ({
  ...
  const [activeRosterPersonas, setActiveRosterPersonas] = useState<Persona[]>(() =>
    getPresetRoster('frontier_trio', personas, synthesizer).personas
  );
  const [activeRosterSynthesizer, setActiveRosterSynthesizer] = useState<Persona>(() =>
    getPresetRoster('frontier_trio', personas, synthesizer).synthesizer
  );
  ...
  const handleSelectEnginePreset = (preset: NexusEnginePreset) => {
    ...
    const roster = getPresetRoster(preset, personas, synthesizer);
  ...
  const getEstimatedCost = (): number => {
    const isFree = enginePreset === 'fast_and_free';
            ...
            <div className="grid grid-cols-2 gap-3 pt-1">
              <div>
                ...
                >
                  ...
                  <option value="fast_and_free">⚡ Fast & Free Tier</option>
