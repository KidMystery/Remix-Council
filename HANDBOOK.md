...
- **Chamber/Nexus sessions** → `council-sessions-v3` (localStorage, exhibit metadata only) + Google Drive `appDataFolder/council-sessions.json` when signed in.
